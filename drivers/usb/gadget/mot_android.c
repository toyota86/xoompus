...
static struct device_pid_vid mot_android_vid_pid[MAX_DEVICE_TYPE_NUM] = {
	{"msc", MSC_TYPE_FLAG | CDROM_TYPE_FLAG, 0x22b8, 0x7086, "Motorola Config 14",
	 USB_CLASS_PER_INTERFACE, USB_CLASS_PER_INTERFACE,
	 USB_CLASS_PER_INTERFACE},
	{"msc_adb", MSC_TYPE_FLAG | ADB_TYPE_FLAG | CDROM_TYPE_FLAG, 0x22b8, 0x7087,
	 "Motorola Config 42", USB_CLASS_PER_INTERFACE,
	 USB_CLASS_PER_INTERFACE, USB_CLASS_PER_INTERFACE},
	{"cdrom", CDROM_TYPE_FLAG, 0x22b8, 0x708d, "Motorola CDROM Device",
	 USB_CLASS_PER_INTERFACE, USB_CLASS_PER_INTERFACE,
	 USB_CLASS_PER_INTERFACE},
	{"eth", ETH_TYPE_FLAG, 0x22b8, 0x7083, "Motorola Config 13",
	 USB_CLASS_COMM, USB_CLASS_COMM, USB_CLASS_PER_INTERFACE},
	{"mtp", MTP_TYPE_FLAG, 0x22b8, 0x7088, "Motorola Config 15",
	 USB_CLASS_PER_INTERFACE,
	 USB_CLASS_PER_INTERFACE, USB_CLASS_PER_INTERFACE},
	{"eth_adb", ETH_TYPE_FLAG | ADB_TYPE_FLAG, 0x22b8, 0x7082,
	 "Motorola Android Composite Device"},
	{"acm_eth_mtp", ACM_TYPE_FLAG | ETH_TYPE_FLAG | MTP_TYPE_FLAG, 0x22b8,
	 0x708a, "Motorola Config 30", USB_CLASS_VENDOR_SPEC,
	 USB_CLASS_VENDOR_SPEC, USB_CLASS_VENDOR_SPEC},
	{"mtp_adb", MTP_TYPE_FLAG | ADB_TYPE_FLAG, 0x22b8, 0x7089,
	 "Motorola Config 32", USB_CLASS_VENDOR_SPEC,
	 USB_CLASS_VENDOR_SPEC, USB_CLASS_VENDOR_SPEC},
	{"acm_eth_mtp_adb",
	 ACM_TYPE_FLAG | ETH_TYPE_FLAG | MTP_TYPE_FLAG | ADB_TYPE_FLAG, 0x22b8,
	 0x708b, "Motorola Config 31", USB_CLASS_VENDOR_SPEC,
	 USB_CLASS_VENDOR_SPEC, USB_CLASS_VENDOR_SPEC},
	{"msc_eth", MSC_TYPE_FLAG | ETH_TYPE_FLAG, 0x22b8, 0x7081,
	 "Motorola Android Composite Device"},
	{"msc_adb_eth", MSC_TYPE_FLAG | ADB_TYPE_FLAG | ETH_TYPE_FLAG, 0x22b8,
	 0x7080, "Motorola Android Composite Device"},
	{"charge_only", MSC_TYPE_FLAG, 0x22b8, 0x708F, "Motorola Config XX",
	 USB_CLASS_PER_INTERFACE, USB_CLASS_PER_INTERFACE,
	 USB_CLASS_PER_INTERFACE},
	{"charge_adb", MSC_TYPE_FLAG | ADB_TYPE_FLAG, 0x22b8, 0x7090,
	 "Motorola Config 50", USB_CLASS_PER_INTERFACE,
	 USB_CLASS_PER_INTERFACE, USB_CLASS_PER_INTERFACE},
	{"rndis", RNDIS_TYPE_FLAG, 0x22b8, 0x7091, "Motorola RNDIS Device",
	 USB_CLASS_WIRELESS_CONTROLLER, USB_CLASS_PER_INTERFACE,
	 USB_CLASS_PER_INTERFACE},
	{"rndis_adb", RNDIS_TYPE_FLAG | ADB_TYPE_FLAG, 0x22b8, 0x7092,
	 "Motorola RNDIS ADB Device",
	 USB_CLASS_PER_INTERFACE, USB_CLASS_PER_INTERFACE,
	 USB_CLASS_PER_INTERFACE},
	{"acm_acm1_acm2_acm3_eth",
				...
				const struct usb_ctrlrequest *ctrl)
{
	...
	for (i = 0; i < android_config_driver.next_interface_id; i++) {
		if (android_config_driver.interface[i]->setup && !(android_config_driver.interface[i]->hidden)) {
			ret =
...
static int __init android_bind(struct usb_composite_dev *cdev)
{
	...
	*/
	...
	ret = usb_add_config(cdev, &android_config_driver, android_bind_config); /* review if this is correct */
	if (ret) {
...
static struct usb_composite_driver android_usb_driver = {
	...
	.strings = dev_strings,
	/*.bind = android_bind,*/
	/*.enable_function = android_enable_function, */ /* review: enable_function is no longer in new kernel's header. see if it is safe just commenting this out. */
};
